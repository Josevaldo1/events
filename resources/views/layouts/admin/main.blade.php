                            ...
                            <div class="item-content">
                                <div class="media">
                                    <div class="item-img bg-skyblue author-online">
                                        <img src="/admin/img/figure/student11.png" alt="img">
                                    </div>
                                ...
                                <div class="media">
                                    <div class="item-img bg-yellow author-online">
                                        <img src="/admin/img/figure/student12.png" alt="img">
                                    </div>
                                    <div class="media-body space-sm">
                                        <div class="item-title">
                                            <a href="#">
                                ...
                                <div class="media">
                                    <div class="item-img bg-pink">
                                        <img src="/admin/img/figure/student13.png" alt="img">
                                    </div>
                                    <div class="media-body space-sm">
                                        <div class="item-title">
                                            <a href="#">
        ...
        <div class="dashboard-page-one">
            ...
            <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
               <div class="mobile-sidebar-header d-md-none">
                    <div class="header-logo">
                        <a href="index.html"><img src="/admin/img/logo1.png" alt="logo"></a>
                    </div>
               </div>
                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        <li class="nav-item">
                            <a href="{{route('home')}}" class="nav-link"><i
                                    class="flaticon-planet-earth"></i><span>Painel</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('site.index')}}" class="nav-link"><i
                        ...
                        <li class="nav-item">
                            <a href="account-settings.html" class="nav-link"><i
                                    class="flaticon-settings"></i><span>Configurações</span></a>
                        </li>
                    </ul>
                </div>
            </div>
